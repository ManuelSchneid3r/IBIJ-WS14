...
\centering{
  ...
  \caption{Die unterschiedlich schattierten Rechtecke stellen Cells unterschiedlicher Circuits dar. Die schwarzen Cells sind bereit zur Weitergabe an die Anwendung werden aber zurückgehalten, weil auf das verlorene Paket gewartet wird. Quelle: \cite{tcp-over-dtls}}
